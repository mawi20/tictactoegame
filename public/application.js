...
function updateGame(token, id, index, value, over) {
  // console.log(token)
  var url = 'http://tic-tac-toe.wdibos.com/games/' + id;
  var data = { 'game': { 'cell': { 'index': index, 'value': value }, 'over': over } };
  $.ajax({
    type: 'PATCH',
    url: url,
    data: data,
...
function createGame(token) {
  var url = 'http://tic-tac-toe.wdibos.com/games';
  $.ajax({
    type: 'POST',
    url: url,
    headers: { 'Authorization': 'Token ' + token }, // WTF? documentation unclear
...
var winner = null;
var turn = 'X';
var state = { r0c0: null, r0c1: null, r0c2: null, r1c0: null, r1c1: null, r1c2: null, r2c0: null, r2c1: null, r2c2: null };
$('#game').hide();
$('#result').hide();
$('#sign-up').submit(function (e) {
  var signUpEmail = $('#sign-up-email').val();
  var signUpPassword = $('#sign-up-password').val();
  var signUpPasswordConfirmation = $('#sign-up-password-confirmation').val();
  var data = { 'credentials': { 'email': signUpEmail, 'password': signUpPassword, 'password_confirmation': signUpPasswordConfirmation } };
  var url = 'http://tic-tac-toe.wdibos.com/sign-up';
  $.ajax({
    type: 'POST',
    url: url,
    data: data,
...
$('#sign-in').submit(function (e) {
  ...
  var data = { 'credentials': { 'email': signInEmail, 'password': signInPassword } };
  var url = 'http://tic-tac-toe.wdibos.com/sign-in';
  $.ajax({
    type: 'POST',
    url: url,
    data: data,
...
$('#sign-out').submit(function (e) {
  ...
  var userId = Cookies.getJSON('userdata').id;
  var userToken = Cookies.getJSON('userdata').token;
  var data = { 'id': userId };
  var url = 'http://tic-tac-toe.wdibos.com/sign-out/' + userId;
  $.ajax({
    type: 'DELETE',
    url: url,
...
$('#change-password').submit(function (e) {
  ...
  var userToken = Cookies.getJSON('userdata').token;
  var data = { 'passwords': { 'old': oldPassword, 'new': newPassword } };
  var userId = Cookies.getJSON('userdata').id;
  var url = 'http://tic-tac-toe.wdibos.com/change-password/' + userId;
  $.ajax({
    type: 'PATCH',
    url: url,
    headers: { 'Authorization': 'Token ' + userToken }, // WTF? documentation unclear
...
$('#current_games').on('click', '.gamelink', function (e) {
  var id = this.id;
  console.log(id);
  var token = Cookies.getJSON('userdata').token;
